...
The core library modules are part of a `boltz-client` rust crate.
...
The language bindings library `boltz-dart`, written for `boltz-client`, will have a more abstracted api.
