...
impl MasterKey {
    pub fn generate(passphrase: &str, network: Network) -> Result<MasterKey, S5Error> {
...
mod tests {
    ...
    fn test_key_ops() {
        ...
        let imported_master_key =
            MasterKey::import(&master_key.mnemonic, "password", Network::Testnet).unwrap();
